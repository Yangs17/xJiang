...
#define HEAP_SIZE         128  //内存大小192K
#define HEAP_END          (0x20000000 + HEAP_SIZE * 1024)

#else


#define HEAP_SIZE         50 *1024 //内存大小192K
static  char 			  rt_ma_buf[HEAP_SIZE];
#define HEAP_END          &rt_ma_buf[HEAP_SIZE-1]
#define HEAP_BEGIN 		  &rt_ma_buf[0]
#endif
