...
//rt_kprintf("%04d-%02d-%02d %02d:%02d:%02d\n", tm_new.tm_year + 1900, tm_new.tm_mon + 1, tm_new.tm_mday, tm_new.tm_hour, tm_new.tm_min, tm_new.tm_sec);
   return    ((DWORD)((tm_new.tm_year - 80) & 0x00000FFF) << 25)
              |((DWORD)((tm_new.tm_mon + 1)  & 0x0000000F) << 21)
              |((DWORD)(tm_new.tm_mday 	     & 0x0000001F) << 16)
              |((DWORD)(tm_new.tm_hour 	     & 0x0000001F) << 11)
              |((DWORD)(tm_new.tm_min 	     & 0x0000003F) << 5)
              |((DWORD)(tm_new.tm_sec 	     & 0x0000003F) >> 1);	
