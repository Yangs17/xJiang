...
#define CHECKSUM_BY_HARDWARE 1   //硬件校验 打开
#define MII_MODE
...
*/
	...
	SYSCFG_ETH_MediaInterfaceConfig(SYSCFG_ETH_MediaInterface_MII); //MAC和PHY之间使用RMII接口
...
static void phy_monitor_thread_entry(void *parameter)
{
    ...
    while(1)
    {
        ...
        if(status & (PHY_AutoNego_Complete | PHY_Linked_Status))
        {
          ...
          SR = ETH_ReadPHYRegister(phy_addr, 0x1E);
