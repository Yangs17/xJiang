...
{
	extern void quitTcpConnect(void);
	quitTcpConnect();
	return 0;
}
FINSH_FUNCTION_EXPORT_ALIAS(cmd_quit, __cmd_quit, Quit connect.);



int cmd_sendlog(int argc, char** argv)
{
	//extern void send_log_diagnosis(void);
	send_log_diagnosis();
	return 0;
}
FINSH_FUNCTION_EXPORT_ALIAS(cmd_sendlog, __cmd_sendlog, send log.);
