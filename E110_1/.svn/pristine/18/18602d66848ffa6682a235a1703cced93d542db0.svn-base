 ...
 *
 * By default mbed TLS uses the system-provided rt_calloc() and free().
 * This allows different allocators (self-implemented or provided) to be
 * provided to the platform abstraction layer.
 *
 * Enabling MBEDTLS_PLATFORM_MEMORY without the
 * MBEDTLS_PLATFORM_{FREE,CALLOC}_MACROs will provide
 * "mbedtls_platform_set_calloc_free()" allowing you to set an alternative rt_calloc() and
 ...
 *
 * Do not assign standard functions in the platform layer (e.g. rt_calloc() to
 ...
 * based buffer to 'allocate' dynamic memory. (replaces rt_calloc() and free()
 * calls)
 *
 ...
 * functions like rt_calloc(), free(), snprintf(), printf(), fprintf(), exit().
 *
...
//#define MBEDTLS_PLATFORM_STD_CALLOC        rt_calloc /**< Default allocator to use, can be undefined */
//#define MBEDTLS_PLATFORM_STD_FREE            rt_free /**< Default free to use, can be undefined */
...
//#define MBEDTLS_PLATFORM_CALLOC_MACRO        rt_calloc /**< Default allocator macro to use, can be undefined */
//#define MBEDTLS_PLATFORM_FREE_MACRO            rt_free /**< Default free macro to use, can be undefined */
